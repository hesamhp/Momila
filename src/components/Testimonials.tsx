...
const testimonials = [
  {
    quote:
      "از وقتی «دفتر ابرِ بنفش» را به کیف دخترم انداختم، مشق‌نوشتن برایش به یک بازی تبدیل شده. کیفیت کاغذ و جلد واقعاً فرق دارد.",
    name: "سارا محمدی",
    role: "مادرِ آوا",
    initials: "س",
  ...
  {
    quote:
      "به‌عنوان معلم کلاس اول، دفترهای مومیلا را به همه پیشنهاد می‌کنم؛ سطرنویسی استاندارد است و کاغذ کرمش به چشم بچه‌ها فشار نمی‌آورد.",
    name: "مریم رضایی",
    role: "معلم دبستان",
    initials: "م",
  ...
  {
    quote:
      "سفارش‌مان سه روزه به دستمان رسید و بسته‌بندی آن‌قدر قشنگ بود که جعبه‌اش هنوز توی اتاق کیان مانده! کیفیت‌هایش هم عالی است.",
    name: "امیر کریمی",
    role: "پدرِ کیان",
    initials: "ا",
    ...
    <section id="testimonials" className="relative overflow-hidden py-20 md:py-28">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading
          ...
          title={
            <>
              حرف‌هایی که <span className="marker-blush">انرژی‌مان</span>{" "}
              می‌دهد
            </>
          }
          description="هزاران خانواده و معلم، هر مهر همراه مومیلا به مدرسه می‌روند؛ این چند جمله، دلیل ادامه دادنِ ماست."
        />
